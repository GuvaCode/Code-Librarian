...
function TSynLuaSyn.GetDefaultAttribute(Index: integer
...
begin
 Result := 'function ordered(t)'+#13#10+
           ' local currentIndex = 0'+#13#10+
           ' local function iter(t)'+#13#10+
           '       currentIndex = currentIndex + 1'+#13#10+
           '       local key = t[currentIndex]'+#13#10+
           '       if key then return key, t[key] end'+#13#10+
           'end'+#13#10+
           'return iter, t'+#13#10+
           'end';
end;
