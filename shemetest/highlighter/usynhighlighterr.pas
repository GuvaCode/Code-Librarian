...
Const
     SYNS_AttrDatasets                              = 'Datasets';
     SYNS_AttrPlotting                              = 'Plotting';
     SYNS_FilterR                                   = 'R language Files (*.r;*.R;*.RData;*.rds;*.rda)|*.r;*.R;*.RData;*.rds;*.rda';
 ...
 *)
  ...
  Programing_Count = 33;
  Programing: array [1..Programing_Count] of String =
    (
    'break',
    'class',
    'do',
  ...
  Functions: array [1..Functions_Count] of String =
    (
    'abline',
    'abs',
    'acf',
  ...
  Datasets_Count = 101;
  Datasets: array [1..Datasets_Count] of String =
    (
    'ability.cov',
    'airmiles',
    'AirPassengers',
  ...
  Plotting_Count = 76;
  Plotting: array [1..Plotting_Count] of String =
    (
    'adj',
    'ann',
    'ask',
...
begin
  ...
  fNoteAttri:= TSynHighlighterAttributes.Create(SYNS_AttrAnnotation);
  fNoteAttri.Foreground:= clRed;
  fNoteAttri.Style:= [fsItalic, fsUnderline, fsBold];
  AddAttribute(fNoteAttri);

  fNote_1Attri:= TSynHighlighterAttributes.Create(SYNS_AttrAnnotation);
  fNote_1Attri.Foreground:= clBlue;
  fNote_1Attri.Style:= [fsItalic, fsBold];
  AddAttribute(fNote_1Attri);

  fNote_2Attri:= TSynHighlighterAttributes.Create(SYNS_AttrAnnotation);
  ...
  fProgramingAttri:= TSynHighlighterAttributes.Create(SYNS_AttrReservedWord);
  fProgramingAttri.Foreground:= clRed;
  //fProgramingAttri.Style:= [fsBold];
  AddAttribute(fProgramingAttri);

  fFunctionsAttri:= TSynHighlighterAttributes.Create(SYNS_AttrReservedWord);
