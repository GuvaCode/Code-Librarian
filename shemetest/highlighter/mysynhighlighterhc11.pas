...
Const
     MYSYNS_Lang68HC11               =  'Assembly 68HC11';
...
procedure TSynHC11Syn.SetLine(const NewValue: String; LineNumber: Integer);
begin
  Inherited;
  FKeyWordType := kwNone;
...
procedure TSynHC11Syn.GetTokenEx(out TokenStart: PChar; out TokenLength: integer
  );
begin
